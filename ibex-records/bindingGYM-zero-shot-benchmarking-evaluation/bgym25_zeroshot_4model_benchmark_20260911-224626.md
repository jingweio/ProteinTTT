...
>
> **只想看结论** → **§22.3（阶段性科学结论，最新）**、§17（侧链对比）、§12.1/§12.3/§12.4（MPNN 家族）。
...
>
> ⚠️ **结论有效性标注**
> - ✅ **已定论且不会再变**：§12.1 的 5 个 MPNN run、§17 的侧链对比（波及范围已在 §21.5 逐个查证）、**§22 的 ADFLIP**
> - 🔄 **尚无有效结果**：LASErMPNN（旧结果已全部作废，见 §21）、StaB-ddG
