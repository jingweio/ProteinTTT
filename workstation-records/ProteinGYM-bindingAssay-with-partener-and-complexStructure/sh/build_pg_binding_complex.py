...
# Input roots. Overridable by env var so the same script runs locally and on the workstation.
# READ-ONLY: this script never writes anywhere except --out.
PG_REF = os.environ.get("PG_REF", "/home/guoj0f/repos/ProteinGym/reference_files/DMS_substitutions.csv")
PG_DIR = os.environ.get("PG_DIR", "/home/guoj0f/share/ProteinGym/DMS_ProteinGym_substitutions")
BG_IDX = os.environ.get("BG_IDX", "/home/guoj0f/share/BindingGYM/input/BindingGYM.csv")
BG_DIR = os.environ.get("BG_DIR", "/home/guoj0f/share/BindingGYM/input/Binding_substitutions_DMS")
BG_PDB = os.environ.get("BG_PDB", "/home/guoj0f/share/BindingGYM/input/structures")
