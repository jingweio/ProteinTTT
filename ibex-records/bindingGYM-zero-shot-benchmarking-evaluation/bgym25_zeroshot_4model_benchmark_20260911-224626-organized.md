...
剩余 16 个外推还需 **约 35–40 GPU-小时**（剩余 n·L 是已完成量的 3.9 倍），是否跑完待定。
...
**成本评估**：剩余 16 个的 n·L = 108,120,324，是已完成量（27,624,023）的 **3.9 倍**，
外推还需 **约 35–40 GPU-小时**。鉴于上面的 ρ=0.967 已回答了核心问题，
**是否值得继续跑完，留给用户决定**（截至本次更新仍在跑，未擅自停止）。
